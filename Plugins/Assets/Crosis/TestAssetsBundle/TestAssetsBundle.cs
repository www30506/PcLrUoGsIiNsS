...
*****************		二樓		****************
	...
	我	檢視	大廳	(刪除大廳)我在大廳的二樓，而前面是前往【一樓】的樓梯。

	我	前往	一樓	我從樓梯往一樓走，此時城堡又傳來巨大的搖晃，天花板上面的燈掉了下來把一樓跟二樓連接的樓梯砸壞了，看來要找其他的方式從【二樓】下去了。
	...
	我	檢視	雕像	(獲得【裝飾(劍)) 一個騎士拿著劍的雕像，在雕像的後面找到一張【紙條】和一個小的【裝飾品】，不知道是誰丟在這邊的。
...
當集合鐘聲響起，一分鐘內穿好頭盔、手套、盔甲、褲子、鞋子，並到集合場集合。
	...
	我	檢視	木盒子	木製的盒子，上面有個鑰匙孔。
	我	開啟	木盒子	我需要用鑰匙才能打開。
	
	鑰匙	開啟	木盒子	(獲得 【裝飾(弓))我使用鑰匙將盒子打開，裡面放著一個【裝飾品】。
	...
	我	完成	螢幕	(刪除梯子)(Ladder > PutDown)當我輸入完螢幕後，機器開始運轉，梯子連結到了一樓。
...
*****************		二樓		****************
	...
	我	檢視	櫃子	(獲得 【裝飾(旗子) 【裝飾(盾)】) 櫃子上面放著許多獎牌，是過去家族在騎士比賽得到的，旁邊有兩個個精緻的【裝飾品】和一把【鑰匙】。
