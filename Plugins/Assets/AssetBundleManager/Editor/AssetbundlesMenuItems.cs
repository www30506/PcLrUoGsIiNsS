...
namespace AssetBundles
{
    public class AssetBundlesMenuItems
    {
		...
		[MenuItem("Assets/AssetBundles/Build AssetBundles Local")]
		static public void BuildAssetBundlesLocal()
		{
			BuildScript.BuildAssetBundlesLocal();
		}

		[MenuItem("Assets/AssetBundles/Build AssetBundles Local from Selection")]
		private static void BuildBundlesLocalFromSelection()
		{
			...
			BuildScript.BuildAssetBundlesLocal(assetBundleBuilds.ToArray());
		}
